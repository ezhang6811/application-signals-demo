...
module.exports = function(){
  ...
  NutritionFact.insertMany([
    ...
    { pet_type: 'gecko', facts: 'Insects (crickets, mealworms, dubia roaches), calcium powder, and vitamin D3 supplements', products: 'GeckoGourmet Cricket Mix, ReptileVitality D3 Formula, ScaleStrong Calcium Boost' }
  ])
