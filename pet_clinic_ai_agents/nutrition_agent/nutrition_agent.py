...
def create_nutrition_agent():
    ...
    system_prompt = (
        ...
        "1. When you call any tool, check if the response starts with 'We currently don't have nutrition products available'\n"
        "2. If you see this message, STOP IMMEDIATELY and return this message to the user - DO NOT generate any recommendations\n"
        "3. NEVER recommend products or nutrition advice from your training data when tools indicate data is unavailable\n\n"
        "When providing nutrition guidance (ONLY if tools return valid data):\n"
